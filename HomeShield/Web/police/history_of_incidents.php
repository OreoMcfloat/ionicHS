                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">HISTORY OF EVENTS</h4>
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<tr>
											...
											<th style="color:black;">INCIDENT REPORT</th>
										...
										while($row = mysqli_fetch_assoc($res))
										{
											...
											$output .= "</td>";
											$output .= "<td>";
											$output .=  "<a href='viewreport.php?owner_contactnumber=$id'><button class=\"btn btn-info\" onclick=\"edit();\"><span class=\"\"></span>VIEW REPORT</button></a>";
											$output .= "</td>";
										$output .= "</tr>";
										}
