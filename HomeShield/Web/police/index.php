                        ...
                        <div class="card card-plain">
                            ...
                            <div class="content table-responsive table-full-width">
								...
								<tr>
											...
											<th style="color:black;">RESPONDED</th>
											<th style="color:black;">RESPOND</th>
										...
										$res = mysqli_query($con, "SELECT * FROM notification_incident LIMIT {$start_index}, 10" );
										$output = "";
										...
										while($row = mysqli_fetch_assoc($res))
										{
											...
											$output .= "</td>";
											$output .= "<td>";
											$output .= "<a href='respond.php?owner_contactnumber=$id'><button class=\"btn btn-info\" id=\"buttons1\"";
											$output .= $row['owner_contactnumber'] . ")\"";
											$output .= ">RESPOND</button></a>";
											$output .= "</td>";
											$output .= "<td>";
											$output .=  "<a href='delete.php?owner_contactnumber=$id'><button class=\"btn btn-danger\" onclick=\"edit();\"><span class=\"\"></span>DELETE</button></a>";
											$output .= "</td>";
